...
for i in 0 1 2 3; do
    ...
    # The second value head adds one 512 x num_actions Linear and four
    # (num_steps, num_envs, num_actions) rollout buffers -- under 2 MB total, so
    # the same 0.22 budget holds.
