...
# Run from the repo root: submit.sh refers to
# pqn_atari_counts_with_seperate_value_head.py, requirements.txt, wheels/ and
...
# stale hardcoded bound silently drops or duplicates runs (the bug 342a117 fixed
# by hand).
RUNS_PER_TASK=4
MAX_ARRAY_SIZE=1000
