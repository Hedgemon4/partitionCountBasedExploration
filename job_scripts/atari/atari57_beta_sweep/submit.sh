...
# 1140 array tasks cover 2280 runs (57 games x 8 betas x 5 seeds), 2 runs per GPU.
# The sweep is launched as two array jobs (MaxArraySize=1000): each starts its array at
# index 0, and TASK_OFFSET shifts it into the shared configs.txt.
